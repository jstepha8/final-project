...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_9|M1_Direction_0_1_Pin|M1_Direction_1_0_Pin|LD2_Pin
                          |LD3_Pin|GPIO_PIN_4|LD1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PB9 PBPin PBPin PBPin
                           PBPin PB4 PBPin */
  GPIO_InitStruct.Pin = GPIO_PIN_9|M1_Direction_0_1_Pin|M1_Direction_1_0_Pin|LD2_Pin
                          |LD3_Pin|GPIO_PIN_4|LD1_Pin;
